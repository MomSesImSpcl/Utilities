...
namespace MomSesImSpcl.Utilities.Pooling
{
    ...
    public abstract class CustomPoolBase<C, T> where C : IReadOnlyCollection<T>, new()
    {
        #region Properties
        /// <summary>
        ...
        #region Constructors
        /// <summary>
        /// <see cref="CustomPoolBase{C,T}"/>.
        /// </summary>
        /// <param name="_MaxCapacity"><see cref="MaxCapacity"/>.</param>
        public CustomPoolBase(int _MaxCapacity = int.MaxValue)
        {

...
{
    /// <summary>
    /// A comparer that sorts elements in ascending order based on a key extracted from the elements.
    /// </summary>
    ...
    public readonly struct AscendingComparer<T,C> : IComparer<T> where C : IComparable<C>
    {
        #region Fields
        /// <summary>
        ...
        public AscendingComparer(Func<T,C> _ComparerKey)
        {
        ...
        #region Methods
        /// <summary>
        /// Compares two elements of <see cref="Type"/> <c>T</c> in ascending order based on the <see cref="comparerKey"/>.
        /// </summary>
        /// <param name="_First">The first element to compare.</param>
        /// <param name="_Second">The second element to compare.</param>
        /// <returns>
        /// A value less than 0 if the key of <c>_First</c> is greater than the key of <c>_Second</c>, <br/>
        /// 0 if the keys are equal, or a value greater than 0 if the key of <c>_First</c> is less than the key of <c>_Second</c>.
        /// </returns>

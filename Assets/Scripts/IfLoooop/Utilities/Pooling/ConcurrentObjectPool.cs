...
namespace IfLoooop.Utilities.Pooling
{
    ...
    public sealed class ConcurrentObjectPool<T> : ObjectPoolBase<ConcurrentQueue<T>, T> where T : ConcurrentPoolWrapperBase<T>, new()
    {
        #region Fields
        /// <summary>
        ...
        #region Constructors
        /// <summary>
        /// <see cref="ConcurrentObjectPool{T}"/>.
        /// </summary>
        /// <param name="_InitialCapacity">The amount of objects to create, when the <see cref="ConcurrentObjectPool{T}"/> is created.</param>
        /// <param name="_MaxCapacity">The maximum number of objects <see cref="ObjectPoolBase{C,T}.ObjectPool"/> can hold at a time.</param>
        public ConcurrentObjectPool(int _InitialCapacity, int _MaxCapacity = int.MaxValue) : base(_MaxCapacity)
        {
        ...
        /// <summary>
        /// Asynchronously retrieves an object from the <see cref="ConcurrentObjectPool{T}"/>.
        /// </summary>
        /// <returns>

...
namespace MomSesImSpcl.Utilities.Pooling
{
    ...
    public static class ObjectPools
    {
        ...
        /// </summary>
        public static CustomPool<StringBuilderPoolWrapper> StringBuilderPool { get; set; }
        /// <summary>
        ...
        /// </remarks>
        public static ConcurrentCustomPool<ConcurrentStringBuilderPoolWrapper> ConcurrentStringBuilderPool { get; set; }
        #endregion
    }
}
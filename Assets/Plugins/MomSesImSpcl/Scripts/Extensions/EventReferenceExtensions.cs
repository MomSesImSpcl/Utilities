...
namespace MomSesImSpcl.Extensions
{
    ...
    public static class EventReferenceExtensions
    {
        ...
        /// <param name="_EventInstance">The <see cref="EventInstance"/> to stop before creating the new one.</param>
        ...
        public static EventInstance PlayOneShot(this EventReference _EventReference, EventInstance _EventInstance, STOP_MODE _StopMode, bool _Release)
        {
        ...
        /// <returns>The <see cref="EventInstance"/> that was created to play the sound.</returns>
        public static EventInstance PlayOneShot(this EventReference _EventReference, PARAMETER_ID _ParameterId, float _ParameterValue)
        {
            var _eventInstance = RuntimeManager.CreateInstance(_EventReference);
        ...
        /// <param name="_Release">Set to <c>true</c> to immediately release the <see cref="EventInstance"/> after starting it.</param>
        /// <returns>The <see cref="EventInstance"/> that was created to play the sound.</returns>
        public static EventInstance PlayOneShot(this EventReference _EventReference, EventInstance _EventInstance, STOP_MODE _StopMode, PARAMETER_ID _ParameterId, float _ParameterValue, bool _Release)
        {
            if (_EventInstance.isValid())
            {
                _EventInstance.stop(_StopMode);
